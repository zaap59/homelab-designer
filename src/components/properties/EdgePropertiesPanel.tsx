...
export function EdgePropertiesPanel() {
  ...
  return (
    ...
    >
      ...
      {/* Footer */}
      <div className="mt-auto px-4 py-2.5 border-t" style={{ borderColor: '#21262d' }}>
        <div style={{ fontSize: 10, color: '#30363d', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
